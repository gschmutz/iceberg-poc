...
FILE_NAME=f"reports/{get_strategy_name().lower()}/scd2_delta_test_logical_del.md"
...
def test_step_2(ctx):
    ...
    # run test
    scd2_merge_as_test(ctx, test_step=2, ins_stmt=insert_sql_2, load_ts=load_ts_2, current_ts=current_ts_2, expected=expected, output_file_name=FILE_NAME, test_description=test_description, use_delta_mode_for_raw_table=True)
