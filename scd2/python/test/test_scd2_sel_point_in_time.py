...
from commons import get_strategy_name, raw_table_fqn, scd2_table_fqn, TRINO_CATALOG, TRINO_SCHEMA, S3_WAREHOUSE_BUCKET, S3_WAREHOUSE_PREFIX, RAW_TABLE_NAME, SCD2_VIEW_NAME, EXCLUDE_COLS, COLS_WITH_TYPE, create_dim_table_for_test, scd2_merge_as_test, scd2_sel_as_test, scd2_merge_as_preparation, create_raw_table

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)

FILE_NAME=f"reports/{get_strategy_name().lower()}/scd2_test_sel_point_in_time.md"
