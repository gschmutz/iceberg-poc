...
FILE_NAME="reports/scd2_test_logical_del_and_reins_gap_same_val.md"
...
def test_step_3():
    ...
    test_description = "Reactivate record with `id=3` by inserting it again but with exactly the same data as the deleted version and perform SCD2 merge."
    ...
    expected = [
        ...
        "SUPERSEDED", "77C069EE2AA3730894A6E3319ADC455C203B6CC4D35B0B912C2FAADF3C687676"),

        (3, "Clara", "Schmid", "Basel", "clara.schmid@example.com",
        load_ts_3, MAX_TS, True, True,
        current_ts_3, current_ts_3, MAX_TS,
        "SUPERSEDED_BY", "77C069EE2AA3730894A6E3319ADC455C203B6CC4D35B0B912C2FAADF3C687676"),
