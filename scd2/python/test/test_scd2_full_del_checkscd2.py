...
FILE_NAME = f"reports/{get_strategy_name().lower()}/scd2_test_full_del_checkscd2.md"
...
def test_step_1(ctx):
    ...
    render_init("Testing Physical Delete Operation by checking against SCD2 table", FILE_NAME)
    render_data(
...
def test_step_2(ctx):
    ...
    # recreate raw table to only have current batch in source table
    create_raw_table(ctx)
