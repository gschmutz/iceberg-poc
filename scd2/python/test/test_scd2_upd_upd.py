...
def test_step_2(ctx):
    ...
    test_description = (
        f"At {load_ts_2}, update `city` of entity with `id=1` and perform SCD2 merge."
    )
...
def test_step_3(ctx):
    ...
    test_description = (
        f"At {load_ts_3}, update `email` of entity with `id=1` and perform SCD2 merge."
    )
