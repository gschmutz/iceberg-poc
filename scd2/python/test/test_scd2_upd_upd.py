...
FILE_NAME=f"reports/{get_strategy_name().lower()}/scd2_test_upd_upd.md"
...
def test_step_3(ctx):
    ...
    # run test
    scd2_merge_as_test(ctx, test_step=3, ins_stmt=insert_sql_3, load_ts=load_ts_3, current_ts=current_ts_3, expected=expected, output_file_name=FILE_NAME, test_description=test_description, perform_merge_op=True)
...
def test_step_4(ctx):
    ...
    # run test
    scd2_merge_as_test(ctx, test_step=4, ins_stmt=insert_sql_4, load_ts=load_ts_4, current_ts=current_ts_4, expected=expected, output_file_name=FILE_NAME, test_description=test_description, perform_merge_op=True)
