...
def test_step_4():
    ...
    # run test
    run_scd2_merge_test(conn, test_step=4, ins_stmt=insert_sql_4, load_ts=load_ts_4, current_ts=current_ts_4, expected=expected, output_file_name=FILE_NAME, test_description=test_description)
...
def test_step_5():
    ...
    # run test
    run_scd2_merge_test(conn, test_step=5, ins_stmt=insert_sql_5, load_ts=load_ts_5, current_ts=current_ts_5, expected=expected, output_file_name=FILE_NAME, test_description=test_description)
