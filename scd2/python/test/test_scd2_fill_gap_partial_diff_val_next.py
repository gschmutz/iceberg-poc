...
FILE_NAME=f"reports/{get_strategy_name().lower()}/scd2_test_fill_gap_partial_diff_val_next.md"
    ...
    insert_sql_3 = f"""
        ...
        FROM (
            VALUES
                ...
                (3, 'Clara', 'Schmid', 'Basel', 'clara.schmid@example.com', 'ACTIVE', TIMESTAMP '{load_ts_4}', TIMESTAMP '{load_ts_4}')
        ) AS t (
            id,
            first_name,
            last_name,
...
def test_step_2(ctx):
    ...
    insert_sql_1 = f"""
        ...
        FROM (
            VALUES
                (1, 'Alice', 'Meyer', 'Zurich', 'alice.meyer@example.com', 'ACTIVE', TIMESTAMP '{load_ts_3}', TIMESTAMP '{load_ts_5}'),
                (2, 'Bob', 'Keller', 'Bern', 'bob.keller@example.com', 'ACTIVE', TIMESTAMP '{load_ts_3}', TIMESTAMP '{load_ts_5}'),
