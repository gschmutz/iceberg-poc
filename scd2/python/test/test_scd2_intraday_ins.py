...
FILE_NAME=f"reports/{get_strategy_name().lower()}/scd2_test_intraday_ins.md"

load_ts_1= datetime.strptime('2026-01-01 09:00:00', '%Y-%m-%d %H:%M:%S')
current_ts_1 = datetime.strptime('2026-01-01 09:05:00', '%Y-%m-%d %H:%M:%S')

load_ts_2 = datetime.strptime('2026-01-01 09:10:00', '%Y-%m-%d %H:%M:%S')
