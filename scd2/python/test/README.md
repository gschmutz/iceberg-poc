...
| 10 | test_scd2_logical_del_and_reins_same_val.py | Performs a Re-Insert into an entity which has previously been deleted. Insert with same values and no gap. | [scd2_test_logical_del_and_reins_same.md](./reports/scd2_test_logical_logical_del_and_reins_same.md) | yes |
| 11 | test_scd2_logical_del_and_reins_diff_val.py | Performs a Re-Insert into an entity which has previously been deleted. Insert with different values and no gap. | [scd2_test_logical_del_and_reins_diff.md](./reports/scd2_test_logical_del_and_reins_diff.md) | yes |
| 12 | test_scd2_logical_del_and_reins_gap_val.py | Performs a Re-Insert into an entity which has previously been deleted. Insert with gap. | [scd2_test_logical_del_and_reins_gap.md](./reports/scd2_test_logical_del_and_reins_gap.md) | yes |
