...
FILE_NAME = f"reports/{get_strategy_name().lower()}/scd2_test_fill_gap_same_val_next.md"
...
def test_step_2(ctx):
    ...
    test_description = f"Fill the gap at {load_ts_2} by adding a record with the same values as the version following the gap."
