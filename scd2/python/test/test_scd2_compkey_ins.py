...
FILE_NAME=f"reports/{get_strategy_name().lower()}/scd2_test_compkey_ins.md"
    ...
    insert_sql_2 = f"""
        ...
        FROM (
            VALUES
                ...
                (3, 3, 'Clara', 'Schmid', 'Basel', 'clara.schmid@example.com', 'ACTIVE', TIMESTAMP '{load_ts_2}', TIMESTAMP '{load_ts_2}'),
