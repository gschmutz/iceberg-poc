...
from commons import TRINO_CATALOG, TRINO_SCHEMA, S3_WAREHOUSE_BUCKET, S3_WAREHOUSE_PREFIX, DIM_TABLE_NAME, RAW_TABLE_NAME, SCD2_VIEW_NAME, EXCLUDE_COLS, COLS_WITH_TYPE, scd2_merge_as_test, scd2_merge_as_preparation, create_raw_table, init_trino_connection
...
def test_step_2():
    ...
    expected = [
        ...
        "DELETED", "B0A5C6A57EF49E849E24BE9F0DC86F9033CF64033CDB2A83F19D76321D1E12C9"),
    ]
