...
|   merge_key |   id | first_name   | last_name   | city    | email                      | load_ts             | status   | change_classification   | operation_type   |
|-------------|------|--------------|-------------|---------|----------------------------|---------------------|----------|-------------------------|------------------|
|           2 |    2 | Bob          | Keller      | Bern    | bob.keller@example.com     | 2026-02-20 00:00:00 | INACTIVE | NEW                     | UPDATE_EXISTING  |
|          10 |   10 | Kevin        | Loosli      | Bern    | kevin.loosli@example.com   | 2026-02-20 00:00:00 | ACTIVE   | NEW                     | UPDATE_EXISTING  |
