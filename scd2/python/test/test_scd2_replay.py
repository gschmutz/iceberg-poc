...
from commons import TRINO_CATALOG, TRINO_SCHEMA, S3_WAREHOUSE_BUCKET, S3_WAREHOUSE_PREFIX, DIM_TABLE_NAME, RAW_TABLE_NAME, SCD2_VIEW_NAME, EXCLUDE_COLS, COLS_WITH_TYPE, create_dim_table_for_test, scd2_merge_as_preparation, scd2_merge_as_test2, create_raw_table, init_trino_connection

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)

FILE_NAME="reports/scd2_test_replay.md"
...
def test_step_1():
    ...
    scd2_merge_as_preparation(conn, ins_stmts=[insert_sql_1,insert_sql_2, insert_sql_3, insert_sql_4]
...
def test_step_4():
    ...
    # run test
    scd2_merge_as_test2(conn, test_step=4,
                        load_ts_list=[load_ts_1, load_ts_2, load_ts_3, load_ts_4], current_ts_list=[current_ts_1, current_ts_2, current_ts_3, current_ts_4], 
