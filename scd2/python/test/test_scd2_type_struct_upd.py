...
FILE_NAME = f"reports/{get_strategy_name().lower()}/scd2_test_type_struct_upd.md"
...
def test_step_1(ctx):
    ...
    render_init("Testing Update Operation with a column of type STRUCT", FILE_NAME)
    render_data(
...
def test_step_2(ctx):
    ...
    insert_sql_2 = f"""
        ...
        FROM (
            VALUES
                ...
                (3, {OBJECT_DATATYPE}('Clara', 'Schmid', 'Basel',  'clara.schmid@newmail.com'), 'ACTIVE', TIMESTAMP '{load_ts_2}', TIMESTAMP '{load_ts_2}')
        ) AS t (
            id,
            user_info,
            status,
    ...
    expected = [
        ...
        (
            3,
            {"first_name": "Clara", "last_name": "Schmid", "city": "Basel", "email": "clara.schmid@example.com"}, # user_info (old version)
            load_ts_1,
        ...
        (
            3,
            {"first_name": "Clara", "last_name": "Schmid", "city": "Basel", "email": "clara.schmid@newmail.com"}, # user_info (new version)
            load_ts_2,
            MAX_TS,
            True,
            True,
