...
FILE_NAME="reports/scd2_test_fill_gap_diff_val_prev_and_next.md"
...
def test_step_1(trino_conn, spark):
    ...
    render_init("Testing Filling a gap with different value than the next version after the gap", FILE_NAME)
    render_data("This test validates filling the gap in a single entity. The record added into the gap is having different values than the version following the gap.", output_file_name=FILE_NAME)
...
def test_step_2(trino_conn, spark):
    ...
    expected = [
        ...
        (3, "Clara", "Schmid", "Zurich", "clara.schmid@example.com",
        load_ts_2, load_ts_3 - timedelta(seconds=1), False, False,
        current_ts_4, MAX_TS,
        "24D761116FACE285ECC3E970FF105F256954CF40802EB4B2944296D89115D95C"),
