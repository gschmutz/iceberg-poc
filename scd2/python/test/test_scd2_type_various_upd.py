...
def test_step_1(ctx):
    ...
    if TEST_ENGINE == "TRINO":
        ...
        insert_sql_1 = f"""
            ...
            FROM (
                VALUES
                    (1, CAST(1 AS TINYINT), CAST(100 AS SMALLINT), 123456, 9876543210L, CAST(3.14 AS FLOAT), 3.141592653589793D, CAST('12345.6789' AS DECIMAL(9,4)), 'hello world', 'limited', CAST('fixed     ' AS CHAR(10)), TRUE,  DATE '2024-01-15', TIMESTAMP '2024-01-15 10:30:00', CAST('2024-01-15 10:30:00' AS TIMESTAMP), 'ACTIVE', TIMESTAMP '{load_ts_1}', TIMESTAMP '{load_ts_1}'),
                    (2, CAST(2 AS TINYINT), CAST(200 AS SMALLINT), 234567, 8765432109L, CAST(2.71 AS FLOAT), 2.718281828459045D, CAST('23456.789'  AS DECIMAL(9,4)), 'world hello', 'another',  CAST('fixed     ' AS CHAR(10)), FALSE, DATE '2024-02-20', TIMESTAMP '2024-02-20 11:45:00', CAST('2024-02-20 11:45:00' AS TIMESTAMP), 'ACTIVE', TIMESTAMP '{load_ts_1}', TIMESTAMP '{load_ts_1}'),
                    (3, CAST(3 AS TINYINT), CAST(300 AS SMALLINT), 345678, 7654321098L, CAST(1.41 AS FLOAT), 1.414213562373095D, CAST('34567.8901' AS DECIMAL(9,4)), 'foo bar',     'short',     CAST('fixed     ' AS CHAR(10)), TRUE,  DATE '2024-03-25', TIMESTAMP '2024-03-25 12:00:00', CAST('2024-03-25 12:00:00' AS TIMESTAMP), 'ACTIVE', TIMESTAMP '{load_ts_1}', TIMESTAMP '{load_ts_1}')
            ) AS t (
                id,
                col_tinyint,
                col_smallint,
