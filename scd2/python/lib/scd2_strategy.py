...
class SCD2Strategy(ABC):
    ...
    * ``dp_record_hash`` – SHA-256 hash of all business columns for change detection.
    ...
    def __init__(
        ...
        col_dp_active_enable = False,
        col_dp_is_latest_enable = False,
        col_dp_replaced_at_enable = False,
        ...
        self.col_dp_active_enable = col_dp_active_enable
        self.col_dp_is_latest_enable = col_dp_is_latest_enable
        self.col_dp_replaced_at_enable = col_dp_replaced_at_enable
