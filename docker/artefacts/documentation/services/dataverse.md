...
Navigate to <http://10.156.72.221:28394>.
Log in with user `dataverseAdmin` and password `admin1`.

You can also access the Payara Admin Console if needed, which is available at <http://10.156.72.221:4848>. Log in with user `admin` and password `admin`.
