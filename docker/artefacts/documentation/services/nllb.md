...
REST API documentation available [here](http://10.156.72.252:28441/api/schema/swagger).

Translate

```bash
curl 'http://10.156.72.252:28441/api/v4/translator?text=Hello&source=eng_Latn&target=spa_Latn'
```
