...
REST API documentation available [here](http://10.156.72.221:28257/api/schema/swagger).

Translate

```bash
curl 'http://10.156.72.221:28257/api/v4/translator?text=Hello&source=eng_Latn&target=spa_Latn'
```
