...
```bash
curl http://10.156.72.221:28256/consumers
```

Show specific consumer group information

```bash
curl http://10.156.72.221:28256/consumers/<consumer-group-id>
```

Show health

```bash
curl http://10.156.72.221:28256/health
```

Metrics

```bash
curl http://10.156.72.221:28256/metrics
```
