...
curl -XPOST -H "Content-Type:application/json" -d"{\"schema\":$SCHEMA}" http://10.156.72.221:8081/subjects/$TOPIC-value/versions
```
...
```bash
export TOPIC=topicName
http http://10.156.72.221:8081/subjects/$TOPIC-value/versions/latest \
