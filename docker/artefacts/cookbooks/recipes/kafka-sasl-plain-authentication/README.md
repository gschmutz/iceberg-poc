...
Navigate to AKHQ on <http://10.156.72.252:28107>.

## KaDeck

Navigate to KaDeck on <http://10.156.72.252:28313>, login as user `admin` with password `admin` and accept the license information.
